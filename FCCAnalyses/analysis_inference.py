...
class RDFanalysis():
    ...
    def analysers(df):
        ...
        from ROOT.VecOps import DeltaPhi
        weaver = JetFlavourUtils.setup_weaver(
            "/afs/cern.ch/user/a/adelvecc/weaver/exports/h_fccee_flavtagging_delphes_edm2.onnx", #name of the trained model exported 
            "/afs/cern.ch/user/a/adelvecc/weaver/exports/preprocess.json",                       #.json file produced by weaver during training
            (
