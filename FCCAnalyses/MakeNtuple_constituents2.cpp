...
int main(int argc, char* argv[]) {
  ...
  ROOT::VecOps::RVec<ROOT::VecOps::RVec<float> > *JetsConstituents_d0 = 0;
  ROOT::VecOps::RVec<ROOT::VecOps::RVec<float> > *JetsConstituents_z0 = 0;
  ...
  ev->SetBranchAddress("JetsConstituents_d0", &JetsConstituents_d0);
  ev->SetBranchAddress("JetsConstituents_z0", &JetsConstituents_z0);
  ...
  for(int i = N_i+1; i < nentries; ++i) {
	...
	pfcand_dxy[k] = (JetsConstituents_d0->at(j))[k];
	pfcand_dz[k] = (JetsConstituents_z0->at(j))[k];
