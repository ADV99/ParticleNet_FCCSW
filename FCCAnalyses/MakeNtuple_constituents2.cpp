...
int main(int argc, char* argv[]) {
  ...
  //std::string inDir = "/eos/home-a/adelvecc/FCCAnalyses/stage1/samples220909_cluster/set_pseudoJets/"; //for samples prefall2022 (centrally generated by Michele) + cluster + set_xyze
  ...
  //std::string outDir("/eos/home-a/adelvecc/FCCAnalyses/Validate_trainvars/samples220909_cluster/set_pseudojets/"); //for validating the variables on  prefall2022 samples (central generation by Michele)
