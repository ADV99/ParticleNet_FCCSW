...
class RDFanalysis():
    ...
    def analysers(df):
        ...
        df2 = (
            ...
            .Define("JetsConstituents_d0", "JetConstituentsUtils::get_d0(JetsConstituents, EFlowTrack_1)")
            .Define("JetsConstituents_z0", "JetConstituentsUtils::get_z0(JetsConstituents, EFlowTrack_1)")
            ...
            .Define("JetsConstituents_Sip2dVal", "JetConstituentsUtils::get_Sip2dVal_cluster(jets_ee_genkt, JetsConstituents, EFlowTrack_1)")
            .Define("JetsConstituents_Sip2dSig", "JetConstituentsUtils::get_Sip2dSig(JetsConstituents_Sip2dVal, JetsConstituents_d0_cov)")
            .Define("JetsConstituents_Sip3dVal", "JetConstituentsUtils::get_Sip3dVal_cluster(jets_ee_genkt, JetsConstituents, EFlowTrack_1)")
            ...
            .Define("JetsConstituents_JetDistVal", "JetConstituentsUtils::get_JetDistVal_cluster(jets_ee_genkt, JetsConstituents, EFlowTrack_1)")
    ...
    def output():
        branchList = [
            ...
            'JetsConstituents_d0', 'JetsConstituents_z0',
